...
UInt h_pcmpistri_4A ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      : "ecx","edx","xmm0","xmm2","xmm7","cc","memory"
   );
...
UInt h_pcmpistri_0C ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x0C,  %%xmm2, %%xmm7"    "\n\t"
      //"pcmpistrm $0x0C,  %%xmm2, %%xmm7"    "\n\t"
      //"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_02 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x02,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x02, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_12 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x12,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x12, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_44 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x44,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x04, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_00 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x00,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x00, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_10 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x10,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x10, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
