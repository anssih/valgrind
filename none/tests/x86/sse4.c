...
typedef __attribute__((aligned(16))) unsigned char V128[16];
...
#define DO_imm_r_to_rscalar(_opname, _imm, _src)       \
   {  \
      UInt _scbefore = 0x55555555UL;  \
      UInt _scafter  = 0xAAAAAAAAUL; \
      /* This assumes that gcc won't make any of %0, %1, %2 */ \
      /* be edi.  That should be ensured (cough, cough) */ \
      /* by declaring edi to be clobbered. */ \
      __asm__ __volatile__(  \
         "movupd (%0), %%xmm2"    "\n\t"  \
         "movl   (%1), %%edi"   "\n\t"  \
         _opname " $" #_imm ", %%xmm2, %%edi"  "\n\t"  \
         "movl   %%edi, (%2)" "\n"  \
         : /*out*/ \
...
#define DO_imm_rscalar_to_r(_opname, _imm, _src)       \
   {  \
      V128  dstv;         \
      V128  res;          \
      UInt src32 = (UInt)(_src); \
      memcpy(dstv, fives, sizeof(dstv)); \
      memcpy(res,  zeroes, sizeof(res)); \
      /* This assumes that gcc won't make any of %0, %1, %2 */ \
      /* be esi.  That should be ensured (cough, cough) */ \
      /* by declaring esi to be clobbered. */ \
      __asm__ __volatile__(  \
         "movupd (%0), %%xmm2"    "\n\t"   /*dstv*/   \
         "movl   (%1), %%esi"     "\n\t"   /*src32*/  \
         _opname " $" #_imm ", %%esi, %%xmm2"   "\n\t"  \
         "movupd  %%xmm2, (%2)" "\n" /*res*/                          \
         : /*out*/ \
         : /*in*/ "r"(&dstv), "r"(&src32), "r"(&res)  \
         : "cc", "memory", "xmm2", "esi"  \
      );  \
      showIGVV("r", (_opname), (_imm), src32, &dstv, &res); \
   }
#define DO_imm_mscalar_to_r(_opname, _imm, _src)       \
   {  \
      ...
      showIGVV("m", (_opname), (_imm), src32, &dstv, &res); \
   }
...
void test_PEXTRB ( void )
{
   V128 src;
   randV128(&src);
   DO_imm_r_to_mandrscalar("pextrb", 0, src);
   DO_imm_r_to_mandrscalar("pextrb", 1, src);
   DO_imm_r_to_mandrscalar("pextrb", 2, src);
   DO_imm_r_to_mandrscalar("pextrb", 3, src);
   DO_imm_r_to_mandrscalar("pextrb", 4, src);
   DO_imm_r_to_mandrscalar("pextrb", 5, src);
   DO_imm_r_to_mandrscalar("pextrb", 6, src);
   DO_imm_r_to_mandrscalar("pextrb", 7, src);
   DO_imm_r_to_mandrscalar("pextrb", 8, src);
   DO_imm_r_to_mandrscalar("pextrb", 9, src);
   DO_imm_r_to_mandrscalar("pextrb", 10, src);
   DO_imm_r_to_mandrscalar("pextrb", 11, src);
   DO_imm_r_to_mandrscalar("pextrb", 12, src);
   DO_imm_r_to_mandrscalar("pextrb", 13, src);
   DO_imm_r_to_mandrscalar("pextrb", 14, src);
   DO_imm_r_to_mandrscalar("pextrb", 15, src);
}
...
void test_PEXTRW ( void )
{
   V128 src;
   randV128(&src);
   DO_imm_r_to_mandrscalar("pextrw", 0, src);
   DO_imm_r_to_mandrscalar("pextrw", 1, src);
   DO_imm_r_to_mandrscalar("pextrw", 2, src);
   DO_imm_r_to_mandrscalar("pextrw", 3, src);
   DO_imm_r_to_mandrscalar("pextrw", 4, src);
   DO_imm_r_to_mandrscalar("pextrw", 5, src);
   DO_imm_r_to_mandrscalar("pextrw", 6, src);
   DO_imm_r_to_mandrscalar("pextrw", 7, src);
}
...
void test_PEXTRD ( void )
{
   V128 src;
   randV128(&src);
   DO_imm_r_to_mandrscalar("pextrd", 0, src);
   DO_imm_r_to_mandrscalar("pextrd", 1, src);
   DO_imm_r_to_mandrscalar("pextrd", 2, src);
   DO_imm_r_to_mandrscalar("pextrd", 3, src);
}
...
void test_EXTRACTPS ( void )
{
   V128 src;
   randV128(&src);
   DO_imm_r_to_mandrscalar("extractps", 0, src);
   DO_imm_r_to_mandrscalar("extractps", 1, src);
   DO_imm_r_to_mandrscalar("extractps", 2, src);
   DO_imm_r_to_mandrscalar("extractps", 3, src);
}
