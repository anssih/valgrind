...
UInt h_pcmpistri_0D ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x0D,  %%xmm2, %%xmm7"    "\n\t"
      //"pcmpistrm $0x0D,  %%xmm2, %%xmm7"    "\n\t"
      //"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_03 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x03,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x03, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_13 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x13,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x13, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
...
UInt h_pcmpistri_01 ( V128* argL, V128* argR )
{
   ...
   __asm__ __volatile__(
      ...
      "movdqu    0(%2),  %%xmm2"            "\n\t"
      "movdqu    16(%2), %%xmm7"            "\n\t"
      "pcmpistri $0x01,  %%xmm2, %%xmm7"    "\n\t"
//"pcmpistrm $0x01, %%xmm2, %%xmm7"    "\n\t"
//"movd %%xmm0, %%ecx" "\n\t"
      "pushfl"                              "\n\t"
      "popl      %%edx"                     "\n\t"
      "movl      %%ecx,  %0"                "\n\t"
